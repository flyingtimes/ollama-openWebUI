...
HF_ENDPOINT=https://hf-mirror.com mlx_lm.lora --model Qwen/Qwen2.5-72B-Instruct  --data data/ --train --iters 5000 --batch-size 4 --lora-layers 16  --adapter-path adapters/Qwen2-72B-$1
